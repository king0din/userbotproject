...
ALL_COMMANDS = [
    ...
    ("🎨 Çıkartma", [
        ...
        (".q (yanıtla)", "Mesajı alıntı çıkartması yapar"),
        (".q <sayı>", "Birden fazla mesajı tek çıkartmada birleştirir"),
        (".q <renk>", "Arka plan rengini seçer (.qrenkler ile bak)"),
        (".qs", "Alıntıyı çıkartma paketine kaydeder"),
        (".qd", "Kayıtlı çıkartmayı paketten siler"),
        (".qpaket", "Paket bilgini gösterir"),
        (".qrenkler", "Kullanılabilir renkleri listeler"),
    ]),
    ("🎭 Profil", [
    ...
    ("✨ Animasyon", [
        ...
        (".efekt <ad> [isim]", "Efekti adıyla çalıştırır (örn: .efekt ufo Ayşe)"),
        (".cop / .ufo / .pota", "Çöpe atar / UFO kaçırır / potaya atar"),
        (".balyoz / .tren / .gol", "Balyozla ezer / tren geçer / kaleye gönderir"),
        (".balik", "Oltayla sudan çeker"),
        (".evlen / .gul / .ask", "Evlenme teklifi / gül verir / atan kalp"),
        (".kalp / .ates / .bomba", "Kalp yağmuru / yakar / bomba geri sayımı"),
        (".hack / .matrix / .tokat", "Hackler / matrix akışı / tokat atar"),
        (".roket / .yildiz / .kader", "Roket fırlatır / yıldız / kader falı"),
    ]),
    ("🛠️ Araçlar", [
